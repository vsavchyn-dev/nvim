--[[
Thanks to Kickstart.nvim for this config!
...
require("lazy").setup({
        ...
        config = function()
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    -- TODO: Change this to code diagnostics maybe
            ...
            -- NOTE: blink doesn't work with the crates.nvim
    ...
    -- WARN: Rustcean copied from Ivan...
    -- TODO: change to what fits me
    {
        "mrcjkb/rustaceanvim",
        lazy = false,
        config = function()
    ...
    -- WARN: blink is not compatible with crates.nvim
    --[[
    { -- Autocompletion
        "saghen/blink.cmp",
        event = "VimEnter",
        ...
        config = function()
            ...
            cmp.setup {
                ...
                sources = {
                    ...
                    { name = "luasnip" },
                    { name = "path" },
                    { name = "crates" }, -- Enables crates.nvim completion
                },
            }
        end,
    },
